...
class heartbeat (
  ...
  Enum['systemd', 'init', 'windows'] $service_provider                = 'systemd',
  ...
  String $service_name                                                = 'heartbeat-elastic',
  String $package_ensure                                              = 'latest',
  Optional[String] $package_name                                      = undef,
  Optional[String] $package_source                                    = undef,
  String $config_file_mode                                            = '0644',
  Boolean $disable_configtest                                         = false,
  String $path_home                                                   = '/usr/share/heartbeat/bin',
  String $path_config                                                 = '/etc/heartbeat',
